...
export class SectorchartComponent implements OnInit 
{
  ...
  {​​​​
    ...
    console.log(this.Sectorcode,this.fromdate,this.fromtime,this.todate,this.totime,this.type);

    this.lineChartType = this.type;

    this.service.getsectorstockpricelist(this.Sectorcode,this.fromdate,this.todate,this.fromtime,this.totime).subscribe(i=>{​​​​
